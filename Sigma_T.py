...
with aba_saida:
    ...
    with st.container():
        ...
        if executar:
            ...
            st.info("Use a barra lateral para configurar os parâmetros e clique em '🚀 Executar análise' ou clique na aba 'ℹ️ Teoria' acima para mais explicações.")
